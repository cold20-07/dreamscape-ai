            ...
            <div className="flex flex-col items-center justify-center gap-0 z-10 mix-blend-difference">
                {keywords.map((word, index) => (
                    <motion.h1
                        ...
                        className="hero-text text-center text-3xl sm:text-5xl md:text-9xl tracking-tighter-custom leading-[0.85] select-none hover:text-transparent hover:stroke-white hover:stroke-1 transition-colors duration-300"
                        style={{
